...
$(document).ready(function () {
    ...
    $('.offer_options').on('change', function () {
      let value = $(this).val();
      if (value == 'old_new') {
        $('.off').addClass('d-none');
        $('.old_new').removeClass('d-none');
        $('.free').addClass('d-none');
      } else if(value == 'off'){
        $('.off').removeClass('d-none');
        $('.old_new').addClass('d-none');
        $('.free').addClass('d-none');
      }
      else{
        $('.off').addClass('d-none');
      ...
      $('.popup_options').on('change', function () {
      let value = $(this).val();
      if (value == 'flyer_popup') {
        $('.simple_popup').addClass('d-none');
        $('.flyer_popup').removeClass('d-none');
      } else if(value == 'simple_popup'){
        $('.simple_popup').removeClass('d-none');
        $('.flyer_popup').addClass('d-none');
      }
    });

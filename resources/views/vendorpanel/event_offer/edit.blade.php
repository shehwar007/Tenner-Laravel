        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="eventForm" action="{{ route('vendor.event.update') }}" method="POST"
              enctype="multipart/form-data"> 
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <img
                      ...
                      alt="..." class="uploaded-img" style="max-width: 100%; width: 200px;">
                  ...
                  <div class="form-group mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        @if(isset($event->media_content))
                            <a class="btn btn-primary btn-sm" href={{route('vendor.offer.remove_media', ['id'=>$event->id])}}>Remove Content</a>
                        @endif
                    </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="rest_title" readonly class="form-control" value="
                     {{ $event->rest_title ??$vendor->name }}" placeholder="Enter Restaurant Title"/> 
                   </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group mt-3">
                      ...
                      <select name="offer_type" class="form-control offer_options">
                        ...
                        <option value="old_new" @if(isset($event) && $event->offer_type=="old_new"){{ "selected" }} @endif>{{ __('Old price/New Price') }}</option>
                        <option value="off"  @if(isset($event) && $event->offer_type=="off"){{ "selected" }} @endif>{{ __('%off') }}</option>
                        <option value="free"  @if(isset($event) && $event->offer_type=="free"){{ "selected" }} @endif>{{ __('free') }}</option>
                      </select>
                    </div> 
                </div> 
                
                <div class="col-lg-6">
                    <div class="form-group off {{ isset($event) && $event->offer_type=="off" ? "":"d-none" }} mt-3">
                      <div>
                        <label>{{ __('Off') . ' *' }}</label>
                ...
                <div class="col-lg-6">
                    <div class="form-group old_new {{ isset($event) && $event->offer_type=="old_new" ? "":"d-none" }} mt-3">
                      <div>
                        <div>

              ...
              <form id="eventForm" action="{{ route('admin.event_management.store_event') }}" method="POST"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <img src="{{ asset('assets/img/noimage.jpg') }}"  style="max-width: 100%; width: 200px;height: 150px;" alt="..." class="uploaded-img">
                  </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="rest_title" class="form-control" placeholder="Enter Restaurant Title"/> 
                   </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group off d-none mt-3">
                      <!--<div>-->
                      <!--  <label>{{ __('Price') . ' *' }}</label>-->
                      <!--  <input type="text" class="form-control" name="offer_price" placeholder="Enter Price">                    -->
                      <!--</div>-->
                      <div>
                        <label>{{ __('Off') . ' *' }}</label>

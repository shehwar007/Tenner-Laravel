                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if($data['user']->loginSecurity == null)
                            <form class="form-horizontal" method="POST" action="{{ url('/admin/2fa/generateSecret') }}">
                                {{ csrf_field() }}
                        ...
                        @elseif(!$data['user']->loginSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="/admin/2fa/enable2fa">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('verify-code') ? ' has-error' : '' }}">
                                    <label for="secret" class="control-label">Authenticator Code</label>
                                    <input id="secret" type="password" class="form-control col-md-4" name="secret" style="border: 1px solid black;" required>
                        ...
                        @elseif($data['user']->loginSecurity->google2fa_enable)
                            ...
                            <form class="form-horizontal" method="POST" action="/admin/2fa/disable2fa">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('current-password') ? ' has-error' : '' }}">
                                    <label for="change-password" class="control-label">Current Password</label>
                                        <input id="current-password" style="border: 1px solid black;" type="password" class="form-control col-md-4" name="current-password" required>
